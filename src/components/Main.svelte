...
<div class="main" data-theme={currentTheme}>
  ...
  <nav class="tabs">
    ...
    <button class="tab" class:active={currentTab === 'addlead'} on:click={() => currentTab = 'addlead'}>
      <svg class="tab-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
      <span>Add Lead</span>
    </button>
    {#if $user?.role === 'manager' || $user?.role === 'admin'}
      <button class="tab" class:active={currentTab === 'manage'} on:click={() => currentTab = 'manage'}>
