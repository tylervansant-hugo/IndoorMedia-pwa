<script>
  ...
  const TRANSLATIONS = {
    en: { title: 'Advertising Investment Summary', store: 'Store', address: 'Address', adType: 'Ad Type', cases: 'Cases', impressions: 'Estimated Impressions', daily: 'Daily', monthly: 'Monthly', annual: 'Annual', paymentPlans: 'Payment Plans', plan: 'Plan', payments: 'payments', perMonth: '/month', total: 'Total', dailyInvestment: 'Daily Investment', bestDeal: 'Best Deal — Save 15%', onePayment: 'One payment', save: 'Save', formula: 'cases × 50 receipts × 137 ft × 2 sides × 4 quarters', poweredBy: 'Generated by imPro Sales Portal — IndoorMedia', yourAd: 'Your ad reaches every customer at checkout — 100% visibility, every transaction.' },
    es: { title: 'Resumen de Inversión Publicitaria', store: 'Tienda', address: 'Dirección', adType: 'Tipo de Anuncio', cases: 'Cajas', impressions: 'Impresiones Estimadas', daily: 'Diario', monthly: 'Mensual', annual: 'Anual', paymentPlans: 'Planes de Pago', plan: 'Plan', payments: 'pagos', perMonth: '/mes', total: 'Total', dailyInvestment: 'Inversión Diaria', bestDeal: 'Mejor Oferta — Ahorre 15%', onePayment: 'Un solo pago', save: 'Ahorre', formula: 'cajas × 50 recibos × 137 pies × 2 lados × 4 trimestres', poweredBy: 'Generado por imPro Sales Portal — IndoorMedia', yourAd: 'Su anuncio llega a cada cliente en la caja — 100% visibilidad, cada transacción.' },
    zh: { title: '广告投资摘要', store: '商店', address: '地址', adType: '广告类型', cases: '收银台数量', impressions: '预估曝光量', daily: '每日', monthly: '每月', annual: '每年', paymentPlans: '付款方案', plan: '方案', payments: '期', perMonth: '/月', total: '总计', dailyInvestment: '每日投资', bestDeal: '最优惠 — 节省15%', onePayment: '一次付清', save: '节省', formula: '收银台 × 50张收据 × 137英尺 × 2面 × 4季度', poweredBy: '由imPro销售平台生成 — IndoorMedia', yourAd: '您的广告触达每一位结账顾客 — 100%可见率，每笔交易。' },
    vi: { title: 'Tóm Tắt Đầu Tư Quảng Cáo', store: 'Cửa hàng', address: 'Địa chỉ', adType: 'Loại quảng cáo', cases: 'Quầy tính tiền', impressions: 'Lượt hiển thị ước tính', daily: 'Hàng ngày', monthly: 'Hàng tháng', annual: 'Hàng năm', paymentPlans: 'Các gói thanh toán', plan: 'Gói', payments: 'kỳ', perMonth: '/tháng', total: 'Tổng', dailyInvestment: 'Đầu tư hàng ngày', bestDeal: 'Ưu đãi tốt nhất — Tiết kiệm 15%', onePayment: 'Thanh toán một lần', save: 'Tiết kiệm', formula: 'quầy × 50 biên lai × 137 ft × 2 mặt × 4 quý', poweredBy: 'Tạo bởi imPro Sales Portal — IndoorMedia', yourAd: 'Quảng cáo của bạn tiếp cận mọi khách hàng tại quầy thanh toán — 100% hiển thị, mọi giao dịch.' },
    tl: { title: 'Buod ng Pamumuhunan sa Advertising', store: 'Tindahan', address: 'Address', adType: 'Uri ng Ad', cases: 'Mga Kaha', impressions: 'Tinatayang Impressions', daily: 'Araw-araw', monthly: 'Buwan-buwan', annual: 'Taun-taon', paymentPlans: 'Mga Plano sa Pagbabayad', plan: 'Plano', payments: 'bayad', perMonth: '/buwan', total: 'Kabuuan', dailyInvestment: 'Pang-araw-araw na Puhunan', bestDeal: 'Pinakamahusay — Save 15%', onePayment: 'Isang bayad', save: 'Tipid', formula: 'kaha × 50 resibo × 137 ft × 2 panig × 4 quarter', poweredBy: 'Ginawa ng imPro Sales Portal — IndoorMedia', yourAd: 'Ang iyong ad ay nakikita ng bawat customer sa checkout — 100% visibility, bawat transaksyon.' },
    ko: { title: '광고 투자 요약', store: '매장', address: '주소', adType: '광고 유형', cases: '계산대 수', impressions: '예상 노출수', daily: '일일', monthly: '월간', annual: '연간', paymentPlans: '결제 플랜', plan: '플랜', payments: '회', perMonth: '/월', total: '합계', dailyInvestment: '일일 투자', bestDeal: '최고 할인 — 15% 절약', onePayment: '일시불', save: '절약', formula: '계산대 × 50영수증 × 137ft × 2면 × 4분기', poweredBy: 'imPro Sales Portal 생성 — IndoorMedia', yourAd: '귀하의 광고는 계산대의 모든 고객에게 도달합니다 — 100% 가시성, 모든 거래.' }
  };
              ...
              <div class="expanded-pricing">
                ...
                {#if caseCount > 0}
                  <div class="impressions-card">
                    ...
                    <div class="imp-formula">{caseCount} cases × 50 receipts × 137 ft × 2 sides × 4 quarters</div>
                  </div>
                {/if}
                {/if}
